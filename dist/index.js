...
define("src/default", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("index", ["require", "exports", "src/default"], function (require, exports, default_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ${style || ''}
    ">${data}</code></pre>`,
        number: (styles, style) => styles.line_numbers.show
            ? `<span style="
    position:absolute;
    ...
    ">${data}</span>`,
        closeButton: (styles) => styles.retractors.show
            ? `<button style="
